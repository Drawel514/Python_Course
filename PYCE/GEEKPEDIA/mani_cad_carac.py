...
#ASIGNACION ( OPERADOR: += ):
"""consiste en asiganr una cadena de caracteres a otra"""
...
""" Es una operacion que consiste en unir dos cadenas o mas, para formar una cadena de mayor tamaño. """
...
#LA ESTRACCION( Posicion a extraer[inicial : final] ):
